# 소개
 ...
 네비게이션 SW는 총 3개의 패키지(pagv_amr_core / pagv_localizer / pagv_motion_controller)로 구성되어 있습니다. 
 pagv_amr_core는 네비게이션 동작판단 / FMS통신 / Planning / Safety를 담당하며, behavior_tree/ amr_core_node/ vda5050_protocol/ navigation으로 구성되어 있습니다. 
