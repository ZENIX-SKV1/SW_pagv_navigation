...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.1.0.3"
  WORKING_DIRECTORY "/home/zenix/ros2_ws/src/amr_emulator/third_party/libvda5050pp/build/_deps/vda5050_message_structs-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.1.0.3" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v2.1.0.3")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v2.1.0.3\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/zenix/ros2_ws/src/amr_emulator/third_party/libvda5050pp/build/_deps/vda5050_message_structs-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/zenix/ros2_ws/src/amr_emulator/third_party/libvda5050pp/build/_deps/vda5050_message_structs-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
