...
TEST_CASE("Config - load/save for sub_configs", "[config][io]") {
  ...
  cfg.refQueryEventHandlerSubConfig().setAllowNodeTriviallyReachableDeviationCheck(true);
  cfg.refQueryEventHandlerSubConfig().setDefaultAcceptZoneSets({"a", "b", "c"});
  ...
  cfg.refQueryEventHandlerSubConfig().setReachableCheckDefaultNodeDeviationTheta(0.5);
  cfg.refQueryEventHandlerSubConfig().setReachableCheckDefaultNodeDeviationXY(1.5);
  cfg.refQueryEventHandlerSubConfig().setReachableCheckOverwriteNodeDeviationTheta(2.5);
  cfg.refQueryEventHandlerSubConfig().setReachableCheckOverwriteNodeDeviationXY(3.5);
  ...
  WHEN("Restoring the file") {
    ...
    THEN("Config stay the same") {
      ...
      REQUIRE(cfg2.lookupCustomConfig("test_config")->as<CustomConfig>().getTestField() ==
              "test_value");
      REQUIRE(cfg2.refQueryEventHandlerSubConfig().getDefaultAcceptZoneSets() ==
              cfg.refQueryEventHandlerSubConfig().getDefaultAcceptZoneSets());
      REQUIRE(cfg2.refQueryEventHandlerSubConfig().getDefaultPauseableSuccess() ==
              cfg.refQueryEventHandlerSubConfig().getDefaultPauseableSuccess());
      REQUIRE(cfg2.refQueryEventHandlerSubConfig().getDefaultResumableSuccess() ==
              cfg.refQueryEventHandlerSubConfig().getDefaultResumableSuccess());
      REQUIRE(cfg2.refQueryEventHandlerSubConfig().getDefaultAcceptZoneSetSuccess() ==
              cfg.refQueryEventHandlerSubConfig().getDefaultAcceptZoneSetSuccess());
      REQUIRE(cfg2.refQueryEventHandlerSubConfig().getReachableCheckDefaultNodeDeviationTheta() ==
              cfg.refQueryEventHandlerSubConfig().getReachableCheckDefaultNodeDeviationTheta());
      REQUIRE(cfg2.refQueryEventHandlerSubConfig().getReachableCheckDefaultNodeDeviationXY() ==
              cfg.refQueryEventHandlerSubConfig().getReachableCheckDefaultNodeDeviationXY());
      REQUIRE(cfg2.refQueryEventHandlerSubConfig().getReachableCheckOverwriteNodeDeviationTheta() ==
              cfg.refQueryEventHandlerSubConfig().getReachableCheckOverwriteNodeDeviationTheta());
      REQUIRE(cfg2.refQueryEventHandlerSubConfig().getReachableCheckOverwriteNodeDeviationXY() ==
              cfg.refQueryEventHandlerSubConfig().getReachableCheckOverwriteNodeDeviationXY());
    }
  }
