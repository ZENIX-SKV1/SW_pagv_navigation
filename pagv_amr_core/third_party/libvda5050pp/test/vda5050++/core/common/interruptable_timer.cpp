...
TEST_CASE("vda5050pp::core::common::InterruptableTimer - interruptAll", "[thread]") {
  GIVEN("A timer and multiple sleeping threads") {
    ...
    std::atomic_bool ret1 = false;
    std::atomic<vda5050pp::core::common::InterruptableTimerStatus> s1;
    std::atomic_bool ret2 = false;
    std::atomic<vda5050pp::core::common::InterruptableTimerStatus> s2;
    std::atomic_bool ret3 = false;
    std::atomic<vda5050pp::core::common::InterruptableTimerStatus> s3;
    std::atomic_bool ret4 = false;
    std::atomic<vda5050pp::core::common::InterruptableTimerStatus> s4;
