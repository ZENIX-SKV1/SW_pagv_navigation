...
TEST_CASE("core::checks::validateActionWithDeclaration", "[core][checks]") {
  ...
  param_float01.ordinal_min = 0.0;
  param_float01.ordinal_max = 1.0;
  ...
  WHEN("An action with only required parameters is checked") {
    ...
    a1.actionParameters = {{{"int", vda5050::json(-1999)}, {"float01", vda5050::json(0.25)}}};
    ...
    auto des = vda5050::json(err).dump();
  ...
  WHEN("An action with optional parameters is checked") {
    ...
    a1.actionParameters = {{{"int", vda5050::json(-1999)},
                            {"float01", vda5050::json(0.25)},
                            {"str", vda5050::json("v2")},
                            {"bool", vda5050::json(true)}}};
...
TEST_CASE("core::checks::uniqueActionId", "[core][checks]") {
  ...
  WHEN("Three distinct actions are checked") {
    auto e1 = vda5050pp::core::checks::uniqueActionId(
        a1, seen, vda5050pp::misc::ActionContext::k_unspecified);
    auto e2 = vda5050pp::core::checks::uniqueActionId(
        a2, seen, vda5050pp::misc::ActionContext::k_unspecified);
    auto e3 = vda5050pp::core::checks::uniqueActionId(
        a3, seen, vda5050pp::misc::ActionContext::k_unspecified);
  ...
  WHEN("Three non distinct actions are checked") {
    ...
    auto e3 = vda5050pp::core::checks::uniqueActionId(
        a1, seen, vda5050pp::misc::ActionContext::k_unspecified);
    auto e4 = vda5050pp::core::checks::uniqueActionId(
        a3, seen, vda5050pp::misc::ActionContext::k_unspecified);
