...
std::shared_ptr<ScopedOrderEventSubscriber> EventHandle::getScopedOrderEventSubscriber() const
    noexcept(false) {
  return vda5050pp::core::Instance::ref().getAgvOrderEventManager().getScopedOrderEventSubscriber();
}
