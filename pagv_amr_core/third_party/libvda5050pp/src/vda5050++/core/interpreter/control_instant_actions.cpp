...
static const vda5050pp::agv_description::ActionDeclaration k_cancelOrderDeclaration{
    ...
    {},
    {},
    {vda5050::BlockingType::HARD, vda5050::BlockingType::SOFT, vda5050::BlockingType::NONE},
    true,
    false,
    false,
};
static const vda5050pp::agv_description::ActionDeclaration k_startPauseDeclaration{
    "startPause",
    "Request the AGV to pause the Order.",
    std::nullopt,
    {},
    {},
    {vda5050::BlockingType::HARD, vda5050::BlockingType::SOFT, vda5050::BlockingType::NONE},
...
static const vda5050pp::agv_description::ActionDeclaration k_stopPauseDeclaration{
    "stopPause",
    "Request the AGV to resume the Order.",
    std::nullopt,
    {},
    {},
    {vda5050::BlockingType::HARD, vda5050::BlockingType::SOFT, vda5050::BlockingType::NONE},
...
vda5050pp::core::interpreter::makeCancelControlBlock(
  ...
  getInterpreterLogger()->debug("Creating cancel control block for action {}", action->actionId);

  auto fn_cancel = std::make_shared<vda5050pp::core::events::FunctionBlock>();
  fn_cancel->setFunction([action] {
    getInterpreterLogger()->debug("Canceling action {}", action->actionId);
  ...
  auto latch_fin = std::make_shared<
      ...
      [](std::shared_ptr<vda5050pp::core::events::OrderStatus> evt) {
        return evt->status == Status::k_order_idle || evt->status == Status::k_order_idle_paused;
      },
      done_fin);

  auto parallel = std::make_shared<vda5050pp::core::events::EventControlParallel>();
  parallel->add(latch_fin);
  parallel->add(fn_cancel);
