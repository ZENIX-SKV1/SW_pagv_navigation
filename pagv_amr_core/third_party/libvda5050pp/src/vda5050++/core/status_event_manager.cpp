...
void ScopedStatusEventSubscriber::subscribe(
    std::function<void(std::shared_ptr<vda5050pp::events::SafetyStateSet>)>
        &&callback) noexcept(true) {
  this->remover_.appendListener(
      vda5050pp::events::StatusEventType::k_safety_state_set,
      eventpp::argumentAdapter<void(std::shared_ptr<vda5050pp::events::SafetyStateSet>)>(
          std::move(callback)));
}
void ScopedStatusEventSubscriber::subscribe(
    std::function<void(std::shared_ptr<vda5050pp::events::SafetyStateGet>)>
        &&callback) noexcept(true) {
  this->remover_.appendListener(
      vda5050pp::events::StatusEventType::k_safety_state_get,
      eventpp::argumentAdapter<void(std::shared_ptr<vda5050pp::events::SafetyStateGet>)>(
          std::move(callback)));
}
void ScopedStatusEventSubscriber::subscribe(
    std::function<void(std::shared_ptr<vda5050pp::events::SafetyStateAlter>)>
        &&callback) noexcept(true) {
  this->remover_.appendListener(
      vda5050pp::events::StatusEventType::k_safety_state_alter,
      eventpp::argumentAdapter<void(std::shared_ptr<vda5050pp::events::SafetyStateAlter>)>(
          std::move(callback)));
}
void ScopedStatusEventSubscriber::subscribe(
...
StatusEventManager::StatusEventManager(const vda5050pp::core::events::EventManagerOptions &opts)
    : opts_(opts),
      thread_(
