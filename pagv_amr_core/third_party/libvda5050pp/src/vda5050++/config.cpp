...
vda5050pp::config::DistanceNodeSubConfig &Config::refDistanceNodeSubConfig() {
  return this->lookupModuleConfig(core::module_keys::k_distance_node_handler)
      ->as<vda5050pp::config::DistanceNodeSubConfig>();
}

const vda5050pp::config::DistanceNodeSubConfig &Config::getDistanceNodeSubConfig() const {
  return this->lookupModuleConfig(core::module_keys::k_distance_node_handler)
      ->as<vda5050pp::config::DistanceNodeSubConfig>();
}
