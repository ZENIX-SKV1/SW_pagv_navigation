...
private:
  std::optional<double> default_node_deviation_xy_;
  std::optional<double> default_node_deviation_theta_;
...
public:
  ...
  ///
  ///\param new_value new xy deviation. (std::nullopt for no default (implicit 0))
  ///
  void setDefaultNodeDeviationXY(std::optional<double> new_value);

  ///
  ///\brief Set the default node theta deviation.
  ///
  ///\param new_value new theta deviation [rad]. (std::nullopt for no default (implicit 0)).
  ///
  void setDefaultNodeDeviationTheta(std::optional<double> new_value);
  ...
  ///\return double
  ///
  std::optional<double> getDefaultNodeDeviationXY() const;
  ...
  ///\return double
  ///
  std::optional<double> getDefaultNodeDeviationTheta() const;
