...
public:
  ...
  ///
  ///\brief Reset the action handler state.
  ///
  /// After returning from this function, the action handler should be in a state, where it contains
  /// no active actions and is ready to accept new actions.
  ///
