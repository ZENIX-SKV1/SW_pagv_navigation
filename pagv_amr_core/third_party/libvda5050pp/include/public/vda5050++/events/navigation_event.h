...
///
///\brief This event is dispatched, when the order was reset. This is a
/// more aggressive form of canceling. Upon dispatching this event, all
/// navigation goals are invalid.
///
/// It is currently only dispatched, when the AGV changes it's mode to manual.
///
struct NavigationReset : public NavigationEvent {};
