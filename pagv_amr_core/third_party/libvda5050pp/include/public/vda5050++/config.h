...
public:
  ...
  ///\brief Get a reference to the mqtt SubConfig
  ///\return vda5050pp::config::MqttSubConfig&
  vda5050pp::config::DistanceNodeSubConfig &refDistanceNodeSubConfig();

  ///\brief Get a const reference to the distanceNode SubConfig
  ///\return const vda5050pp::config::DistanceNodeSubConfig&
  const vda5050pp::config::DistanceNodeSubConfig &getDistanceNodeSubConfig() const;
