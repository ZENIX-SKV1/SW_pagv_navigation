...
using ConstraintValue = std::variant<std::string, int64_t, double, bool>;
...
struct ParameterRange {
  ...
  ///
  std::optional<ConstraintValue> ordinal_min;

  ///
  ///\brief maximum value type (for string int float and bool)
  ///
  /// Optional for ordinal value types.
  ///
  std::optional<ConstraintValue> ordinal_max;
  ...
  ///
  std::optional<std::set<ConstraintValue, std::less<>>> value_set;
