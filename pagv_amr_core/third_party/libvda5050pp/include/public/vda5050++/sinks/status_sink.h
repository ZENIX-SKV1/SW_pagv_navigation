...
public:
  ...
  ///
  ///\brief Set the state.safetyState.
  ///
  ///\param safety_state the new SafetyState.
  ///\throws VDA5050PPNotInitialized if the library is not initialized.
  ///
  void setSafetyState(const vda5050::SafetyState &safety_state) const noexcept(false);

  ///
  ///\brief Get the current state.safetyState.
  ///
  ///\return vda5050::SafetyState the current safety state.
  ///\throws VDA5050PPNotInitialized if the library is not initialized.
  ///
  vda5050::SafetyState getSafetyState() const noexcept(false);

  ///
  ///\brief Alter the current state.safetyState.
  ///
  ///\param alter_function the altering function
  ///\throws VDA5050PPNotInitialized if the library is not initialized.
  ///
  void alterSafetyState(std::function<void(vda5050::SafetyState &)> &&alter_function) const
      noexcept(false);
