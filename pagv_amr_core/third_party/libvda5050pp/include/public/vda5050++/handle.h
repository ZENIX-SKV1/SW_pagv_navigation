...
public:
  ...
  ///
  ///\brief Get a new ControlSink. It can be used to control the library's scheduler.
  /// Pausing/resuming/canceling the current order. Note that these actions will be reflected by
  /// actions in the state and may interfere with the MC's state. Use with care.
  ///
  ///\return vda5050pp::sinks::ControlSink
  ///
  vda5050pp::sinks::ControlSink getControlSink() const;
