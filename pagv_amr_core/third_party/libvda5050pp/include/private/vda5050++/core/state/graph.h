...
///
///\brief The GraphElement class represents a node or an edge in the graph
///
class GraphElement {
private:
  ///\brief holds the actual element
...
public:
  ...
  ///
  ///\brief Construct a new GraphElement from a node
  ///
  ///\param node the node
  ///
  ///\throws VDA5050PPNullPointer if node is nullptr
  ///
  explicit GraphElement(std::shared_ptr<vda5050::Node> node) noexcept(false);

  ///
  ///\brief Construct a new GraphElement from an edge
  ///
  ///\param edge the edge
  ///
  ///\throws VDA5050PPNullPointer if edge is nullptr
  ///
  explicit GraphElement(std::shared_ptr<vda5050::Edge> edge) noexcept(false);

  ///
  ///\brief Get the sequenceId of the element
  ///
  ///\return SequenceId the element's sequenceId
  ///
  ...
  ///
  ///\return std::string_view the element's id
  ///
  std::string_view getId() const;

  ///
  ///\brief Is this element a node?
  ///
  ...
  ///
  ///\brief Is the element part of the horizon?
  ///
  ///\return true if it is part of the horizon
  ///
  bool isHorizon() const;

  ///
  ///\brief Is the element part of the base?
  ///
  ///\return true if it is part of the base
  ///
  bool isBase() const;

  ///
  ///\brief Get the actual node of the element
  ///
  ///\return std::shared_ptr<vda5050::Node> the node
  ///
  ///\throws VDA5050PPInvalidArgument if the element is not a node
  ///
  std::shared_ptr<vda5050::Node> getNode() noexcept(false);

  ///
  ///\brief Get the actual edge of the element
  ///
  ///\return std::shared_ptr<vda5050::Edge> the edge
  ///
  ///\throws VDA5050PPInvalidArgument if the element is not an edge
  ///
...
public:
  ...
  ///
  ///\brief Check if AGV on the graph has an order. Still has a base/horizon infront of it.
  ///
  ///\return bool has order?
  ///
  bool hasOrder() const noexcept(true);
  ...
  /// \return all nodes
  std::list<std::shared_ptr<const vda5050::Node>> getNodes() const;

  /// \brief Construct a list containing all edges
  /// \return all edges
  std::list<std::shared_ptr<const vda5050::Edge>> getEdges() const;

  /// \brief Construct a vector containing all nodes
  /// \return all nodes
  std::vector<std::shared_ptr<const vda5050::Node>> getNodesVec() const;

  /// \brief Construct a vector containing all edges
  /// \return all edges
  std::vector<std::shared_ptr<const vda5050::Edge>> getEdgesVec() const;
