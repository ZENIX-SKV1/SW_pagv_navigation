...
///
///\brief Convert a libvda5050++ action declaration into a vda5050 factsheet action declaration
///
///\param decl the libvda5050++ action declaration
///\return vda5050::AgvAction the converted vda5050 factsheet action declaration
///
