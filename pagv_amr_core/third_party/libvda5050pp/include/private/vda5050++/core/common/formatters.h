...
//
// This file contains common libfmt formatters for libVDA5050++ types
//
...
template <> struct formatter<vda5050pp::agv_description::ConstraintValue> : formatter<string_view> {
  template <typename FormatContext>
  auto format(const vda5050pp::agv_description::ConstraintValue &cv, FormatContext &ctx) const {
    return formatter<string_view>::format(std::visit(
